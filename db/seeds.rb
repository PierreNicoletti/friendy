...
julie = Friend.create!(user: laura, name: "Julie", birth_date: "01/05/1999", gender: "female", address: "Avenue Denfert-Rochereau, Paris 14e Arrondissement, Île-de-France, France", description: "Very friendly person hanger to meet new people. I like good beers and hanging out with my dog", price: 320)
david = Friend.create!(user: laura, name: "David", birth_date: "01/02/1987", gender: "male", address: "Los Angeles (CA)", description: "Ready to rock your world. Lorem ipsum dolor sit amet, consectetur adipisicing elit.", price: 220)
...
jenny = Friend.create!(user: lionel, name: "Jenny", birth_date: "01/05/1990", gender: "male", address: "Mairie du 20e arrondissement, Paris, Île-de-France, France", description: "Je sais faire la roue et les crêpes au sucre. Lorem ipsum dolor sit amet, consectetur adipisicing elit.", price: 75)
...
Booking.create!(friend: tina, user: laetitia, start_date: "15/01/2019", end_date: "19/01/2019")
